...
const FaqsContainer = () => {
  return (
    <div className="about-container">
      ...
      <p>
  		We want to show the strength of our unity on one issue. The more that people come together to express their views, the more environmental leaders will be created!
  	  </p>
